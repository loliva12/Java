...
public class SuppliersController implements ActionListener, MouseListener, KeyListener {
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.suppliers_table) {
            ...
            if (rol.equals("Administrador")) {
                ...
                JOptionPane.showMessageDialog(null, "No tienes provilegios como administrador para acceder");
            }
        }
    }
    ...
    public void getSupplierName(){
       ...
       for(int i = 0; i < list.size(); i++){
           ...
           views.cmb_supplier_purchase.addItem(new DynamicCombobox(id, name));
       }
    }
