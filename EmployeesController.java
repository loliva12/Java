    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == views.btn_register_employee){
            if(views.txt_employee_id.getText().equals("") 
                ...
                if(employeeDao.registerEmployeeQuert(employee)){
                    cleanTable();
                    cleanFields();
                    listAllEmployees();
           ...
           if(views.txt_employee_id.equals("")){
               ...
               if(views.txt_employee_id.getText().equals("")
                   ...
                   JOptionPane.showMessageDialog(null, "Todos los campos son obligatorios");
                    ...
                    if(employeeDao.updateEmployeeQuert(employee)){
                        cleanTable();
                        cleanFields();
                        listAllEmployees(); 
            ...
            int row = views.employees_table.getSelectedRow(); //Almacena el registro que presionó el usuario
            ...
            //Verificar si las cajas de textos estan vacias
   ...
   //Listar todos los empleados
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getSource() == views.employees_table){
            int row = views.employees_table.rowAtPoint(e.getPoint());   //es para ver dpnde se hizo click
