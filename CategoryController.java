...
public class CategoryController implements ActionListener, MouseListener, KeyListener {
    ...
    public CategoryController(Categories category, CategoriesDao categoryDao, SystemView views) {
        ...
        this.views.txt_search_cartegory.addKeyListener(this);
    ...
    public void listAllCategories() {
        if (rol.equals("Administrador")) {
            List<Categories> list = categoryDao.listCategoriesQuery(views.txt_search_cartegory.getText());
    ...
    public void mouseClicked(MouseEvent e) {
        if (e.getSource() == views.categories_table) {
            ...
            if(rol.equals("Administrador")){
                ...
                JOptionPane.showMessageDialog(null, "No tienes provilegios de administrados para acceder");
    ...
    public void keyReleased(KeyEvent e) {
        if (e.getSource() == views.txt_search_cartegory) {
            //Limpiar table
            cleanTable();
            //Listar categorias
            listAllCategories();
